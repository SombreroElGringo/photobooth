...
| overlays | Should be a array of `paths` to some `images` to use as default `overlay`. The `size` of the `image` for the `overlay` must be `320 pixels 320 pixels height` |
